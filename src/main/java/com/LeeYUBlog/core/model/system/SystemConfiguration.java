package com.LeeYUBlog.core.model.system;
...
@Table(name = "SYSTEM_CONFIGURATION", schema= SchemaConstant.LEEYUBLOG_SCHEMA)
public class SystemConfiguration extends LeeYUBlogEntity<Long, SystemConfiguration> implements Serializable, Auditable {

	private static final long serialVersionUID = -7858908635059793185L;
